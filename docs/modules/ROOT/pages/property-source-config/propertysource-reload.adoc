...
the (Spring Cloud Kubernetes Configuration Watcher)[xref:spring-cloud-kubernetes-configuration-watcher.adoc#spring-cloud-kubernetes-configuration-watcher] controller for an alternative way
